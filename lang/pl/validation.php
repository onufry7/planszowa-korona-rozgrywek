...
return [
    ...
    */
    ...
    'hex_color' => 'Pole :attribute musi mieć prawidłowy kolor heksadecymalny.',
    ...
    'list' => 'Pole :atrybut musi być listą.',
    ...
    'min' => [
        ...
        'numeric' => 'Pole :attribute musi być większe od :min.',
    ...
    */
    ...
    'attributes' => [
        ...
        'excerpt' => 'Wyjątek',
        'first_name' => 'Imię',
        'for_registered' => 'Dla zarejestrowanych',
        'gender' => 'Płeć',
        'hour' => 'Godzina',
        'last_name' => 'Nazwisko',
        'message' => 'Wiadomość',
